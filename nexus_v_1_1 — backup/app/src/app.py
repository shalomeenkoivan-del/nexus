...
def command():
    ...
    if cmd == "login nyxx":
        ...
        return jsonify({'output': 'MASTER NYXX-mode activated! Opening chat...', 'redirect': '/loading'})
    ...
    if cmd.startswith("login "):
        ...
        if user_data:
            ...
            return jsonify({'output': f'Successfully authenticated! Opening chat...', 'redirect': '/loading'})
        else:
